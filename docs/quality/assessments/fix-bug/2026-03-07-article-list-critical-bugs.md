...
- `docs/quality/assessments/fix-bug/INVESTIGATION-autosave-trigger.md`（既有調查記錄）
- `docs/engineering/discussions/topic-019-2026-03-07-autosave-on-switch-behavior/PENDING.md`（待決策）
