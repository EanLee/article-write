...
2. **撰寫報告**：
   - 建立或更新 `docs/quality/assessments/fix-bug/YYYY-MM-DD-問題.md`

3. **通知使用者**：
   ```
   我已完成修復並推送到 fix/問題描述 分支

   Bug Fix 報告：docs/quality/assessments/fix-bug/YYYY-MM-DD-問題.md
...
```bash
# 搜尋特定功能模組
grep -r "editor" docs/quality/assessments/fix-bug/
grep -r "article" docs/quality/assessments/fix-bug/

# 搜尋特定日期
ls docs/quality/assessments/fix-bug/2026-01-*

# 搜尋特定關鍵字
grep -r "frontmatter" docs/quality/assessments/fix-bug/
```
