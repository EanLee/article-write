...
> `mixedDirs` 宣告）。**跨目錄依 domain 檢視，請參考** [INDEX-by-domain.md](./conventions/INDEX-by-domain.md)。
...
| 文件 | 說明 | 適合對象 |
|------|------|---------|
| [PRODUCT_SPEC.md](./product/business/PRODUCT_SPEC.md) | 產品願景、核心問題、功能定位 | 所有人 |
| [AI_BLOG_WRITING_TOOL_ANALYSIS.md](./product/business/AI_BLOG_WRITING_TOOL_ANALYSIS.md) | AI 輔助寫作的定位分析、競品對比 | PM, 行銷 |
| [ANALYSIS_REPORT.md](./quality/assessments/ANALYSIS_REPORT.md) | UI/UX 與知識管理深度分析 | 設計師, 開發者 |
| [POTENTIAL_ISSUES.md](./quality/assessments/POTENTIAL_ISSUES.md) | 已知問題清單、優先級分類 | 開發者, QA |

### 2. architecture/ - 系統架構設計

| 文件 | 說明 | 適合對象 |
|------|------|---------|
| [ARCHITECTURE_COMPLETE.md](./engineering/ARCHITECTURE_COMPLETE.md) | **完整架構文件**（理想設計 + 現狀問題 + 重構路線圖） | 技術主管, 架構師 |
...
| 文件 | 說明 | 適合對象 |
|------|------|---------|
| [TESTING_GUIDE.md](./quality/assessments/testing/TESTING_GUIDE.md) | 功能測試步驟、預期結果 | QA, 開發者 |
| [AUTOMATED_TESTING_GUIDE.md](./quality/assessments/testing/AUTOMATED_TESTING_GUIDE.md) | 自動化測試指南 | 開發者 |
| [MANUAL_TESTING_GUIDE.md](./quality/assessments/testing/MANUAL_TESTING_GUIDE.md) | 手動測試流程 | QA |
| [PERFORMANCE_CODE_REVIEW.md](./quality/assessments/testing/PERFORMANCE_CODE_REVIEW.md) | 性能與程式碼品質審查 | 開發者 |
...
| [CORRECT_PRIORITY_ROADMAP.md](./delivery/plans/CORRECT_PRIORITY_ROADMAP.md) | 優先級路線圖 | PM, 技術主管 |
| [PHASE_0_GAP_ANALYSIS.md](./quality/assessments/PHASE_0_GAP_ANALYSIS.md) | Phase 0 差異分析 | PM |

### 6. settings/ - 設定面板設計

| 文件 | 說明 | 適合對象 |
|------|------|---------|
| [SETTINGS_COMPLETE.md](./product/business/SETTINGS_COMPLETE.md) | **完整設定面板文件**（設計目標 + 改版對比 + 實作細節） | 設計師, 開發者 |
| [SETTINGS_QUICK_REFERENCE.md](./product/business/SETTINGS_QUICK_REFERENCE.md) | 設定面板結構快速導覽 | 所有人 |
| [UI_COMPARISON.md](./product/business/UI_COMPARISON.md) | UI 設計對比分析 | 設計師 |
...
- [README.md](./quality/assessments/fix-bug/README.md) - Bug Fix 報告撰寫規範
...
- [README.md](./engineering/adr/README.md) - ADR 索引
- [ADR-0001-codemirror6-editor-migration.md](./engineering/adr/ADR-0001-codemirror6-editor-migration.md)
...
1. 查看 [INDEX-by-domain.md](./conventions/INDEX-by-domain.md)，依 `domain`（product/engineering/quality/delivery/conventions/operations）分組瀏覽
...
| 主題 | 現行版本（SoT） | 已取代版本 |
|--------|--------|------|
| 系統架構 | [ARCHITECTURE_COMPLETE.md](./engineering/ARCHITECTURE_COMPLETE.md) | ARCHITECTURE.md、ARCHITECTURE_ANALYSIS.md |
| 設定面板 | [SETTINGS_COMPLETE.md](./product/business/SETTINGS_COMPLETE.md) | SETTINGS_COMPARISON.md、SETTINGS_REDESIGN.md |
