...
本議題由以下三個嚴重 Bug 的根因分析觸發（詳見 `docs/quality/assessments/fix-bug/2026-03-07-article-list-critical-bugs.md`）。
...
- `docs/quality/assessments/fix-bug/2026-03-07-article-list-critical-bugs.md` — Bug 報告（含 Bug 3 根因分析）
- `docs/conventions/ROUNDTABLE-DISCUSSIONS-INDEX.md` — 本議題索引
