...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  // Search
  searchQuery: (query: { query: string; filters?: { category?: string; status?: string; tags?: string[] } }) => ipcRenderer.invoke(IPC.SEARCH_QUERY, query),
  searchBuildIndex: (articlesDir: string) => ipcRenderer.invoke(IPC.SEARCH_BUILD_INDEX, articlesDir),
  ...
  aiSetApiKey: (provider: string, key: string) => ipcRenderer.invoke(IPC.AI_SET_API_KEY, provider, key),
