...
| 文件位置 | `docs/<domain>/discussions/topic-NNN-.../`（索引：`docs/conventions/ROUNDTABLE-DISCUSSIONS-INDEX.md`） | `docs/<domain>/discussions/T-XXX-*.md`（索引：`docs/conventions/governance/team-composition.md`） |
...
3. 讀 `docs/conventions/governance/team-composition.md` 確認技術現況
...
- 討論完成後補充「設計決策」章節，更新 `team-composition.md` 索引

完整規則見 `docs/conventions/governance/roundtable-rules.md`。
